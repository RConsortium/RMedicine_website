...
<button class="btn btn-primary" style="background-color: #009473" onclick="window.location.href='https://r-consortium.org/webinars/make-your-first-r-open-source-project-contribution.html'">
