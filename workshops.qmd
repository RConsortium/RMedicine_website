...
![](images/david-aja.jpg){style="border-radius: 50%; width: 75%"} ![](images/Shannon_small-square.jpg){style="border-radius: 50%; width: 75%"}
...
![](images/catalina-square.jpeg){style="border-radius: 50%; width: 75%"} ![](images/francisco-square.jpeg){style="border-radius: 50%; width: 75%"}
