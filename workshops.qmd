...
[Richard Hanna](INFO HERE){target="_blank"} & [Stephan Kadauke](INFO HERE){target="_blank"}
:::
::: {.workshop-desc}
...
## Promover la Equidad Científica {#equidad}
...
::: {.card-right}
::: {.workshop-speakers-name}
[Catalina Cañizares](INFO HERE){target="_blank"} & [Francisco Cardozo](INFO HERE){target="_blank"}
:::
::: {.workshop-desc}
...
::: {.card-right}
::: {.workshop-speakers-name}
[Daniel D. Sjoberg](INFO HERE){target="_blank"} & [Shannon Pileggi](INFO HERE){target="_blank"}
:::
::: {.workshop-desc}
...
::: {.card-right}
::: {.workshop-speakers-name}
[Charlotte Wickham](INFO HERE){target="_blank"}
:::
::: {.workshop-desc}
...
::: {.card-right}
::: {.workshop-speakers-name}
[Ray](INFO HERE){target="_blank"}, [Brandon](INFO HERE){target="_blank"}, [Rich](INFO HERE){target="_blank"}, others
:::
::: {.workshop-desc}
INFO HERE
:::
...
::: {.card-right}
::: {.workshop-speakers-name}
[François Michonneau](INFO HERE){target="_blank"}
:::
::: {.workshop-desc}
...
::: {.card-right}
::: {.workshop-speakers-name}
[Cara Thompson](INFO HERE){target="_blank"}
:::
::: {.workshop-desc}
...
::: {.card-right}
::: {.workshop-speakers-name}
[Sara Altman](INFO HERE){target="_blank"}
:::
::: {.workshop-desc}
