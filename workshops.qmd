...
[Richard Hanna](INFO HERE){target="_blank"}
:::
::: {.workshop-desc}
...
::: {.card-right}
::: {.workshop-speakers-name}
[Raymond Balise](INFO HERE){target="_blank"}, [Richard Hanna](INFO HERE){target="_blank"}, [Brandon](INFO HERE){target="_blank"}, others
:::
::: {.workshop-desc}
COMING SOON
:::
...
:::
::: {.workshop-links}
[Workshop GitHub repo](https://github.com/Appsilon/tealflow-demo )
:::
:::
:::
...
:::
::: {.workshop-links}
[Demo GitHub repo](https://github.com/nrennie/r-medicine-2026-parameterized-reports)
:::
:::
:::
